...
class AdminController extends AbstractController
{
   ...
   */
  public function createCategory(EntityManagerInterface $entityManager, SluggerInterface $slugger, Request $request): Response
  {
    ...
    if ($form->isSubmitted() && $form->isValid()) {
      ...
      //Il y a une autre façon de proceder pour setter ces proprietes de Categorie
  ...
  {    
    ...
    //Varibilisation de l'ancien nom de la categorie pour le addFlash()
  ...
  public function restoreCategory(Categorie $categorie, EntityManagerInterface $entityManager): Response
  {
    ...
    $this->addFlash('success', "La categorie " . $categorie->getName() . " a bien été restaurée");
  ...
  */
  public function hardDeleteCategory(Categorie $categorie, EntityManagerInterface $entityManager):Response
  {
    ...
    $this->addFlash('success', "La categorie " . $categorie->getName() . " a bien été supprimé deffinitivement de la base de données");
